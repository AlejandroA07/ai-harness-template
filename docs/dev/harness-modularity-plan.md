...
- **Status:** five-module direction agreed; M0 safety corrections, M1 catalog/planning, M2 selective skill lifecycle and M3 selected global configuration implemented and verified
