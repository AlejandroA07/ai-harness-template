...
- **Status:** five-module direction agreed; M0 safety corrections, M1 catalog/planning, M2 selective skill lifecycle, M3 selected global configuration and M4 selected project configuration implemented and locally verified
