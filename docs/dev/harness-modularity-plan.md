...
- **Status:** five-module direction agreed; M0–M4 and M5a canonical project-scoped Skills implemented and locally verified; M5b workflows are next
...
This is the logical view. M2 makes machine-scoped Skills independently installable; the remaining module lifecycles follow in later slices.
